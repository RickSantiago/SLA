			...
			<ol class="property-list pessoa">
				...
				<li class="fieldcontain">
					<span id="endereco-label" class="property-label"><g:message code="pessoa.endereco.label" default="Endereco" /></span>
						...
						<span class="property-value" aria-labelledby="endereco-label"><g:link controller="endereco" action="show" id="${pessoaInstance?.endereco?.id}">${pessoaInstance?.endereco?.encodeAsHTML()}</g:link></span>
