		...
		<div id="list-pessoa" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="pessoa.endereco.label" default="Endereco" /></th>
					
						<th><g:message code="pessoa.plano.label" default="Plano" /></th>
				...
				<g:each in="${pessoaInstanceList}" status="i" var="pessoaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: pessoaInstance, field: "plano")}</td>
