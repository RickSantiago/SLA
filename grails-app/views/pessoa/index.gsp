		...
		<div id="list-pessoa" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="enderecoDescricao" title="${message(code: 'pessoa.enderecoDescricao.label', default: 'Endereco Descricao')}" />
				...
				<g:each in="${pessoaInstanceList}" status="i" var="pessoaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: pessoaInstance, field: "enderecoDescricao")}</td>
