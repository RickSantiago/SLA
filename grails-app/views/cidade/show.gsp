	...
	<body>
		...
		<div id="show-cidade" class="content scaffold-show" role="main">
			...
			<ol class="property-list cidade">
				...
				<g:if test="${cidadeInstance?.cep}">
				<li class="fieldcontain">
					<span id="cep-label" class="property-label"><g:message code="cidade.cep.label" default="Cep" /></span>
					
						<span class="property-value" aria-labelledby="cep-label"><g:fieldValue bean="${cidadeInstance}" field="cep"/></span>
				...
				<li class="fieldcontain">
					<span id="pessoa-label" class="property-label"><g:message code="cidade.pessoa.label" default="Pessoa" /></span>
